...
const flowerList = [
    ...
    alt: ''},
  {
    id: 5, 
    name: 'Crocus', 
    imageUrl: 'public/images/red-roses-bhttps://images.unsplash.com/photo-1488979246948-f4b573b1fae8?ixid=MXwxMjA3fDB8MHxzZWFyY2h8NXx8Y3JvY3VzfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=60',
    rating: 5,
    alt: ''}
    ...
    return (
        ...
        {flowerList ? flowerList.map(flower => 
          <div className={classes.root}>
              <p>{flower.name}</p> 
              <img src={flower.imageUrl} alt={flower.alt} style={{width:"128px", height: "128px"}}></img>
          </div>
        ) 
