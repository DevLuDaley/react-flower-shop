...
const flowerList = [
  ...
  {id: 5, name: 'Crocus', imageUrl: 'public/images/red-roses-bhttps://images.unsplash.com/photo-1488979246948-f4b573b1fae8?ixid=MXwxMjA3fDB8MHxzZWFyY2h8NXx8Y3JvY3VzfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=60', rating: 5}
    ...
    return (
        ...
        {flowerList ? flowerList.map(flower => 
          <div>
              ...
              <img src={flower.imageUrl}  style={{width:"128px", height: "128px"}}></img>
          </div>
        ) 
